...
st.markdown(
    ...
    * Below the map showing all cities with Amtrak stations, find the distance and emissions **per passenger** by train versus car
    * View a zoomed-in map that plots the cities on the Amtrak route between the origin and destination cities
