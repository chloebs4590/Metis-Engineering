...
st.markdown(
    ...
    **Note**: The destination city options reflect a simplified version of the true Amtrak network, since the web app does not account for the ability to transfer between routes.
